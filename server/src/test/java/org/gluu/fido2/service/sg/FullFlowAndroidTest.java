...
import org.gluu.as.common.model.common.User;
import org.gluu.as.model.config.BaseDnConfiguration;
import org.gluu.as.model.config.StaticConfiguration;
import org.gluu.as.model.fido.u2f.protocol.AuthenticateResponse;
...
import org.gluu.fido2.service.processor.assertion.U2FSuperGluuAssertionFormatProcessor;
import org.gluu.fido2.service.processor.attestation.U2FSuperGluuAttestationProcessor;
...
import org.gluu.fido2.service.shared.CustomScriptService;
...
import org.gluu.junit.extension.FileParameterExtension;
import org.gluu.junit.extension.Name;
import org.gluu.orm.PersistenceEntryManager;
import org.gluu.orm.model.fido2.Fido2AuthenticationEntry;
import org.gluu.orm.model.fido2.Fido2AuthenticationStatus;
import org.gluu.orm.model.fido2.Fido2RegistrationEntry;
import org.gluu.orm.model.fido2.Fido2RegistrationStatus;
...
@AddBeanClasses(org.gluu.service.util.Resources.class)
@AddBeanClasses(org.gluu.service.net.NetworkService.class)
